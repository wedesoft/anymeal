...
; The file to write
OutFile "anymeal-installer-1.21.exe"
...
Section "AnyMeal (required)"
  ...
  File "C:\msys64\mingw64\bin\libicudt69.dll"
  File "C:\msys64\mingw64\bin\libicuin69.dll"
  File "C:\msys64\mingw64\bin\libicuuc69.dll"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\AnyMeal" "DisplayVersion" "1.21"
