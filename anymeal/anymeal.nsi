...
; The file to write
OutFile "anymeal-installer-1.14.1.exe"
...
Section "AnyMeal (required)"
  ...
  File "C:\msys64\mingw64\bin\libicudt68.dll"
  File "C:\msys64\mingw64\bin\libicuin68.dll"
  File "C:\msys64\mingw64\bin\libicuuc68.dll"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\AnyMeal" "DisplayVersion" "1.14.1"
